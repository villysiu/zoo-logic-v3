    ...
    return(
        ...
        <div className='techstack_wrapper'>
            <Card className='techstack'>
                ...
                <p>
                <h3>About </h3>
                Zoo Logic is a logic game, which players place the animal tokens on the board to satisfy the requirement.
                ...
                <li>Used React useReducer hook to render the updated gameboard state after user placed token on click and to start/reset game.</li>
